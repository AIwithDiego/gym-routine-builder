...
Include what you found, where (file, route or URL), and the steps to reproduce it. A proof of concept helps, but please don't access data that isn't yours, run denial-of-service tests or use automated scanners against the live deployment.
